...
const columns = [
  ...
  { field: 'action', headerName: 'Action', width: 150, 
        renderCell: (params) => {
            return(
                <Link to={"/teamMember/" + params.row.id}>
...
const rows = [
  ...
  { id: 2, lastName: 'Freeden', firstName: 'Beth', title: 'Workforce Specialist', phoneNumber: '303-636-1260', email: 'bfreeden@arapahoegov.com', caseload: 50 },
  ...
  { id: 5, lastName: 'Burdette', firstName: 'Austin', title: 'Workforce Specialist', phoneNumber: '303-636-1260', email: 'aburdette@arapahoegov.com', caseload: 50  },
